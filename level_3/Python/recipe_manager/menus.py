...
def main_menu(recipe_list):
    ...
    try:
        ...
        print("\nERROR - The application encountered a fatal error. Please contact a system administrator.")
...
def recipe_view_menu(recipe_list):
    ...
    try:
        ...
        print("\nERROR - The application encountered an error while trying to view recipe list. Please contact a system administrator.")
        error = traceback.format_exc()
        core_functions.log_error(error)
...
def recipe_add_menu(recipe_list):
    ...
    try:
        ...
        print("\nERROR - The application encountered an error while trying to add a recipe. Please contact a system administrator.")
        error = traceback.format_exc()
        core_functions.log_error(error)
...
def recipe_edit_menu_list(recipe_list):
    ...
    try:
        ...
        print("\nERROR - The application encountered an error while trying to edit a recipe. Please contact a system administrator.")
        error = traceback.format_exc()
        core_functions.log_error(error)
...
def recipe_delete_menu(recipe_list):
    ...
    try:
        ...
        print("\nERROR - The application encountered an error while trying to delete a recipe. Please contact a system administrator.")
        error = traceback.format_exc()
        core_functions.log_error(error)
...
def recipe_search_menu(recipe_list):
    ...
    try:
        ...
        print("\nERROR - The application encountered an error while trying to search for a recipe. Please contact a system administrator.")
        error = traceback.format_exc()
        core_functions.log_error(error)
